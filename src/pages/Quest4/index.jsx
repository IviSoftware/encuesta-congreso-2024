...
function Quest4() {
  ...
  const keysTraduction3 = [
    "Medio por el que se enteró del congreso",
    "Kit adecuado",
    "Transmisión adecuada",
    "Medios audiovisuales",
    "Instalaciones adecuadas",
    "Distribución de salones",
    "Información en stands",
    ,
    "Medios audiovisuales",
    "Viaje por la salud",
    "Temas abordados",
  ...
  const keysTraduction4 = [
    "Nivel de contenidos",
    "Distribución de actividades",
    "Tiempo de actividades",
    "Selección de ponentes",
    "Participación de ponentes",
    "Comunicación de ponentes",
  ];

  const keysToValidate5 = [
    "extraCumplieronObjetivos",
    "extraConferenciaInteresantes1",
    "extraConferenciaInteresantes2",
  ...
  const keysTraduction5 = [
    "Cumplimiento de objetivos",
    "Conferencias interesantes",
    "Conferencias interesantes 2",
    "Organización del congreso",
    "Cumplimiento de expectativas",
    "Escala de objetivo académico",
    "Recomendación del congreso",
    "Acudurias al congreso",
  ];

  const keysToValidate6 = ["extraObservacionesConclusiones"];
  const keysTraduction6 = ["Observaciones"];

  const { fullName, estadoProcedenciaAsistente, telefonoAsistente } =
    getBasicData();
  ...
  return (
    <ContainerQuest
      title="Encuesta de satisfacción Personas que viven con diabetes, familiares y público en general (Presencial)"
      ...
      {stage === 1 && (
        <div className="w-full flex flex-col gap-6">
          ...
          <InputCautivaForms
            ...
            dataModule={dataModule}
            type="text"
            text="Estado de procedencia"
            name="extraEstadoProcedencia"
            valueUser={estadoProcedenciaAsistente}
          />
          <OptionsCautivaForms
            setDataModule={setDataModule}
            dataModule={dataModule}
            ...
            name="extraTipoDiabetes"
          />
          <CautivaBtnForm
            text="Continuar"
            onClick={() => {
              const response = validateObjectFields(
                dataModule,
                keysToValidate1,
                keysTraduction1
              );
              if (response.validate === 0) {
                ...
                Swal.fire({
                  title:
                    "Por favor coloque una edad valida, mayores de 18 años",
                  icon: "info",
                });
      ...
      {stage === 3 && (
        <div className="w-full flex flex-col gap-6">
          ...
          <OptionsCautivaForms
            setDataModule={setDataModule}
            dataModule={dataModule}
            text="Los medios audiovisuales dentro de cada ponencia fueron adecuados y visibles en las transmisiones"
            options={["Sí", "No"]}
            name="extraMediosAudiovisualesVisibles"
          />
          <OptionsCautivaForms
            setDataModule={setDataModule}
            dataModule={dataModule}
            text="¿Consideras que las instalaciones sede del congreso fueron adecuadas?"
            options={["Sí", "No"]}
            name="extraInstalacionesAdecuadas"
          />
          <OptionsCautivaForms
            setDataModule={setDataModule}
            dataModule={dataModule}
            text="La distribución de los salones fue adecuada"
            options={["Sí", "No"]}
            name="extraDistribucionSalones"
          />
          <OptionsCautivaForms
            setDataModule={setDataModule}
            dataModule={dataModule}
            text="Los stands en la zona comercial contaban con información relevante y complementaria al objetivo del congreso"
            options={["Sí", "No"]}
            name="extraStandsInformacionRelevante"
          />
          <OptionsCautivaForms
            setDataModule={setDataModule}
            dataModule={dataModule}
          ...
          <OptionsCautivaForms
            setDataModule={setDataModule}
            dataModule={dataModule}
            text="¿Los medios audiovisuales dentro de cada ponencia fueron adecuados y visibles en las transmisiones (pantallas, audios, etc.)?"
            options={["Sí", "No"]}
          ...
          <OptionsCautivaForms
            setDataModule={setDataModule}
            dataModule={dataModule}
            text="¿Consideras que el viaje por la salud fue una idea innovadora y acorde al objetivo del congreso?"
            options={["Sí", "No"]}
            name="extraViajeSaludInnovador"
          />
          <OptionsCautivaForms
            setDataModule={setDataModule}
            dataModule={dataModule}
      ...
      {stage === 4 && (
        <div className="w-full flex flex-col gap-6">
          ...
          <OptionsCautivaForms
            setDataModule={setDataModule}
            dataModule={dataModule}
            text="La distribución de actividades fue"
          ...
          <OptionsCautivaForms
            setDataModule={setDataModule}
            dataModule={dataModule}
            text="El tiempo asignado a cada una de las actividades fue"
          ...
          <OptionsCautivaForms
            setDataModule={setDataModule}
            dataModule={dataModule}
            text="La selección de los ponentes ha sido"
          ...
          <OptionsCautivaForms
            setDataModule={setDataModule}
            dataModule={dataModule}
            text="La participación de los ponentes ha sido"
          ...
          <OptionsCautivaForms
            setDataModule={setDataModule}
            dataModule={dataModule}
            text="¿Crees que los ponentes han propiciado una buena comunicación durante las actividades?"
            options={["Sí", "No"]}
      ...
      {stage === 5 && (
        <div className="w-full flex flex-col gap-6">
          <OptionsCautivaForms
            setDataModule={setDataModule}
            dataModule={dataModule}
            text="¿Consideras que los ponentes y actividades han cumplido los objetivos del programa?"
            options={["Sí", "No"]}
            name="extraCumplieronObjetivos"
          />

          <label className="TextTitleFormComponent">
            Menciona al menos dos plenarias, simposios o talleres que te
            parecieron más interesantes del congreso
          </label>
          <InputCautivaForms
            setDataModule={setDataModule}
            dataModule={dataModule}
            type="text"
            name="extraConferenciaInteresantes1"
          />
          <InputCautivaForms
            setDataModule={setDataModule}
            dataModule={dataModule}
            type="text"
            name="extraConferenciaInteresantes2"
          />

          <OptionsCautivaForms
            setDataModule={setDataModule}
            dataModule={dataModule}
            text="¿Consideras que la organización general del congreso fue satisfactoria?"
            options={["Sí", "No"]}
