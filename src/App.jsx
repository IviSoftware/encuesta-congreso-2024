  ...
  return (
    <>
      ...
      <TransitionGroup>
        ...
        {questState === "questStarting" && questType === "questOne" && (
          <CSSTransition
            in={questState}
            timeout={300}
            classNames="fade"
        ...
        {questState === "questStarting" && questType === "questTwo" && (
          <CSSTransition
            in={questState}
            timeout={300}
            classNames="fade"
        ...
        {questState === "questStarting" && questType === "questThree" && (
          <CSSTransition
            in={questState}
            timeout={300}
            classNames="fade"
        ...
        {questState === "questStarting" && questType === "questFour" && (
          <CSSTransition
            in={questState}
            timeout={300}
            classNames="fade"
